...
from agent_tools.dualipa.llm_generator import (
    generate_code_qa_pairs,
    generate_markdown_qa_pairs,
    generate_reverse_qa_pairs
)
from agent_tools.dualipa.qa_validator import (
...
async def test_temperature_variation_in_code_qa_generation():
    ...
    with patch('agent_tools.dualipa.llm_generator.retry_llm_call') as mock_llm_call:
