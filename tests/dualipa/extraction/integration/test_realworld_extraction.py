...
def requests_repo():
    ...
    # First check project_root / "test_repos" / "requests"
    requests_path = project_root / "test_repos" / "requests"
    if not requests_path.exists():
        # Also check in the root directory
        root_requests_path = Path("/home/grahama/workspace/experiments/agent_tools/test_repos/requests")
        if root_requests_path.exists():
            return root_requests_path
