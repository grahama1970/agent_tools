...
try:
    ...
    import agent_tools.dualipa.code_extractor
    print("Successfully imported agent_tools.dualipa.code_extractor module")
    ...
    print("Successfully imported extraction functions from code_extractor")
    HAS_DEPENDENCIES = True
except ImportError as e:
    try:
        # Try relative imports
        import src.agent_tools.dualipa.code_extractor
        print("Successfully imported src.agent_tools.dualipa.code_extractor module")
        ...
        print("Successfully imported extraction functions from src.agent_tools.dualipa.code_extractor")
        HAS_DEPENDENCIES = True
    except ImportError as e2:
        HAS_DEPENDENCIES = False
        print(f"Error importing from agent_tools: {e}")
        print(f"Error importing from src.agent_tools: {e2}")
        import traceback
        traceback.print_exc()
