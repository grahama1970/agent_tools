"""
Command-line interface for DuaLipa.

This module defines the command-line interface for the DuaLipa toolkit,
allowing users to interact with its functionality through the terminal.
"""
